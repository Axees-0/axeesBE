...
if not exist "%VENV_DIR%" (
    ...
    echo WARNING: Virtual environment not found at %VENV_DIR% >> "%LOG_FILE%"
    echo Checking alternative locations... >> "%LOG_FILE%"
    
    if exist "%PROJECT_ROOT%venv" (
        echo Found virtual environment at %PROJECT_ROOT%venv
        echo Found virtual environment at %PROJECT_ROOT%venv >> "%LOG_FILE%"
        set "VENV_DIR=%PROJECT_ROOT%venv"
    ) else if exist "%SCRIPT_DIR%venv" (
        echo Found virtual environment at %SCRIPT_DIR%venv
        echo Found virtual environment at %SCRIPT_DIR%venv >> "%LOG_FILE%"
...
echo Checking for .env file at: %PROJECT_ROOT%.env
if exist "%PROJECT_ROOT%.env" (
    ...
    echo WARNING: .env file not found, using default port settings
    echo WARNING: .env file not found, using default port settings >> "%LOG_FILE%"
)
