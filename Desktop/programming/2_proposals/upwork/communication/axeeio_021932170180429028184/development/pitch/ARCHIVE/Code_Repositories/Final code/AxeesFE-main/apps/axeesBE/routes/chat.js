...
const checkAndSendNotification = async (msg, receiverId) => {
  // Wait 2 minutes before sending notification if message is still unread
  const NOTIFICATION_DELAY = process.env.NOTIFICATION_DELAY_MS || 120000; // 2 minutes default
