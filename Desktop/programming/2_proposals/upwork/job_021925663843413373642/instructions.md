...
## Project: Senior ML Engineer - Healthcare Graph Neural Network for Episode Prediction - AI & Machine Learning
...
**Client Requirements**: 
   - Summary
   - We are seeking an experienced machine learning engineer to develop a production-ready Graph Neural Network (GNN) system that analyzes medical claims data to predict when patients are entering specific episodes of care. This is a critical component of our healthcare cost management platform that will provide early intervention opportunities for better patient outcomes and cost optimization.
