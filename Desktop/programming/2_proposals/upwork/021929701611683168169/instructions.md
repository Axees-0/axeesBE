...
## Project: AI-Driven Conversion Optimization Tool Development - Web Development

### Project Context
**Budget**: $20000-$20000
**Duration**: {label:K,weeks:9},extendedBudgetInfo:{hourlyBudgetMin:a,hourlyBudgetMax:a,hourlyBudgetType:a},contractorTier:e,description:L,segmentationData:[{customValue:a,label:"Ongoing project",name:"Employment",sortOrder:l,type:"EMPLOYMENT",value:"EMPLOYMENT_POSITION",skill:a}],clientActivity:{lastBuyerActivity:"2025-06-03T00:48:11 months
...
✔️ Familiarity with conversion rate optimization (CRO) 
